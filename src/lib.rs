pub mod fiddlerparser {
	...
	pub const MAGIC_ZIP_EMPTY: &[u8; 4] = b"\x50\x4B\x05\x06";
	pub const MAGIC_ZIP_SPANNED: &[u8; 4] = b"\x50\x4B\x07\x08";
    }
    ...
    impl fmt::Display for ZipError {
        fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
            match *self {
                ...
                ZipError::Error => write!(f, "Zip file was not generated by Fiddler."),
            }
        }
    }
