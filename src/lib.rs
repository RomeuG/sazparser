pub mod sazparser {
    ...
    impl fmt::Display for SazError {
        fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
            match *self {
                SazError::Empty => write!(f, "Zip file is empty."),
                SazError::Spanned => write!(f, "Zip file is spanned."),
                SazError::Invalid => write!(f, "Zip file is invalid."),
                SazError::Error => write!(f, "Zip file was not generated by Fiddler."),
            }
        }
    }
